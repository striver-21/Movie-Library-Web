...
export default function Register() {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await Axios.post("http://localhost:4000/api/users/register", registerUser);
                ...
                <div className="card signin-card">
                    <div className="card-body">
                        ...
                        <form onSubmit={onSubmit} className="form-signin">
                            ...
                            <div className="form-group">
                                <button className="btn btn-sm btn-primary btn-block text-uppercase signin-btn" type="submit">Register</button>
                            </div>
